...
import foyer.services.IReservationService;
...
public class ReservationRestController {
    ...
    public Reservation ajouter(@RequestParam String numChambre, @RequestParam String cin) {
    ...
    public String annuler(@RequestParam String cinEtudiant) {
