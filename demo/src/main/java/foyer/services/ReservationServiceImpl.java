...
import foyer.entities.*;
import foyer.repositories.*;
...
public class ReservationServiceImpl implements IReservationService {
    ...
    public Reservation ajouterReservationEtAssignerAChambreEtAEtudiant(
            String numChambre, String cin) {

        Chambre chambre   = chambreRepo.findByNumeroChambre(Long.parseLong(numChambre));
    ...
    @Override
    public Reservation annulerReservation(String cinEtudiant) {
        Etudiant etudiant = etudiantRepo.findByCin(Long.parseLong(cinEtudiant));
